(define (problem star6)
  (:domain starpz)
  (:objects O C B A d1 d2 d3 d4 d5 d6)
  (:init
	...
	(smaller d6 C)(smaller d6 B)(smaller d6 A)
    (smaller d1 O)(smaller d2 O)(smaller d3 O)(smaller d4 O)(smaller d5 O)(smaller d6 O)
    ...
    (on d1 d2)(on d2 d3)(on d3 d4)(on d4 d5)(on d5 d6)(on d6 A)
  )
  (:goal 
    (and (on d1 d2)(on d2 d3)(on d3 d4)(on d4 d5)(on d5 d6)(on d6 C) )
  )
)
